...
class AppNavigationScreen extends GetWidget<AppNavigationController> {
  ...
  onTapEnternumberpage() {
    Get.toNamed(
      AppRoutes.enterNumberPageScreen,
    );
  }

  onTapConfimOTPpageOne() {
    Get.toNamed(
      AppRoutes.confimOtpPageOneScreen,
    );
  }

  onTapGoBackpageOne() {
    Get.toNamed(
      AppRoutes.goBackPageOneScreen,
    );
  }
  ...
  onTapEnternumberpageOne() {
    Get.toNamed(
      AppRoutes.enterNumberPageOneScreen,
    );
  }

  onTapConfimOTPpage() {
    Get.toNamed(
      AppRoutes.confimOtpPageScreen,
    );
  }

  onTapGoBackpage() {
    Get.toNamed(
      AppRoutes.goBackPageScreen,
    );
  }
  ...
  onTapCampingpage() {
    Get.toNamed(
      AppRoutes.campingPageScreen,
    );
  }

  onTapTrippage() {
    Get.toNamed(
      AppRoutes.tripPageScreen,
    );
  }
  ...
  onTapFavoris() {
    Get.toNamed(
      AppRoutes.favorisScreen,
    );
  }

  onTapEditprofilOne() {
    Get.toNamed(
      AppRoutes.editProfilOneScreen,
    );
  }
