...
class TripPageScreen extends GetWidget<TripPageController> {
  @override
                ...
                child: SingleChildScrollView(
                    child: Container(
                        ...
                        child: Stack(alignment: Alignment.topCenter, children: [
                          ...
                          CustomImageView(
                              imagePath: ImageConstant.imgRectangle278,
                              height: getVerticalSize(77),
                              width: getHorizontalSize(184),
                              radius:
                                                              ...
                                                              children: [
                                                                Align(
                                                                    ...
                                                                    child: Text(
                                                                        ...
                                                                        style: AppStyle
                                                                            .txtPoppinsRegular11
                                                                            .copyWith(letterSpacing: getHorizontalSize(0.11)))),
                                                                CustomImageView(
                          ...
                          CustomImageView(
                              svgPath: ImageConstant.imgCloseTeal40001,
                              height: getSize(41),
                              width: getSize(41),
                              alignment: Alignment.bottomRight,
                              margin: getMargin(right: 109, bottom: 23)),
                          CustomImageView(
                              imagePath: ImageConstant.imgUntitled12,
                              height: getSize(54),
                              width: getSize(54),
                              alignment: Alignment.bottomRight,
                              margin: getMargin(right: 102, bottom: 16))
                        ])))),
            bottomNavigationBar:
